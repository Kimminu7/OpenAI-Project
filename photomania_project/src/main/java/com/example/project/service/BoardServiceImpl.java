...
public class BoardServiceImpl implements BoardService {
    ...
    public BoardDTO saveBoard(BoardDTO boardDTO) {
        ...
        if (optionalMember.isPresent()) {
            ...
            boardEntity.setNotice(boardDTO.isNotice());

            if (!"ROLE_ADMIN".equals(member.getRole().value())) {
                boardEntity.setNotice(false);
            }
            // 게시글 저장
...
//        List<Board> boards = boardRepository.findByBoardList();
...
//    }
    ...
    public PageResultDTO<BoardDTO, Board> getList(PageRequestDTO requestDTO) {
        ...
        Page<Board> result = boardRepository.findByBoardList(pageable);
